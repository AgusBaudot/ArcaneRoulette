...
namespace Foundation
{
    ...
    /// Unbroken and transition to Destroyed exactly once, via IDestructible.OnDeath.
    /// </summary>
    ...
    /// <summary>
    /// Contract for anything that can be broken by an Impact. Implemented by
    /// DestructibleSystem (World). Consumed the same way IDamageable is consumed
    /// by DamageSystem: the called resolved the hit, the destructible just reacts.
    /// </summary>
